...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Summer12321@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:Summer12321@localhost")  # No database specified
